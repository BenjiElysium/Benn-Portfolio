...
<template>
  <Disclosure as="nav" :class="{ 'hidden-navbar': !isNavbarVisible, 'visible-navbar': isNavbarVisible }" class="navbar bg-zinc-900/90" v-slot="{ open }">
      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex flex-shrink-0 items-center">
            <img class="block h-8 w-auto ms-10 lg:hidden" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500"
              alt="Philip logo" />
